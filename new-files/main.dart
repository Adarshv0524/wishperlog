...
class _WishperLogApp extends StatelessWidget {
  const _WishperLogApp();
    ...
    return BlocBuilder<ThemeCubit, ThemeMode>(
      builder: (context, themeMode) {
        return MaterialApp.router(
          ...
          // OverlayRootWrapper renders a Stack so the bubble always floats on
          // top of every route without any OverlayEntry or BuildContext stored
          ...
          builder: (context, child) {
            ...
            return OverlayRootWrapper(child: child ?? const SizedBox.shrink());
          },
        );
      },
    );
